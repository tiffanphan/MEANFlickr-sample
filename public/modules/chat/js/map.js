var app = angular.module('AngularGoogleMap', [,'ui','google-maps']);
	app.directive('AngularGoogleMap', function(){
		return{
			restrict:'g',
			template:'<div></div>',
			replace:true,
			link:
/*app.factory('MarkerCreatorService', */function (scope, element, attrs) {
